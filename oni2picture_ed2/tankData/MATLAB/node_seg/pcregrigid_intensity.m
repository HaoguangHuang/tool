function [tform, movingReg, rmse] = pcregrigid_intensity(moving, fixed, varargin)
...
if qs(1) ~= 0 || any(qs(2:end,1))
    locA = rigidTransform(ptCloudA.Location, Rs(:,:,1), Ts(:,1));   %intial transform
end
