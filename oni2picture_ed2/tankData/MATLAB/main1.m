...
for k = 36 %1:frameNum
    ...
    colormap = imread(sprintf('/home/hhg/Downloads/dataSet/Wajueji_2/foreground%dcolor_20.png',k));
    I(:,:,1) = mat2gray(mask)*255;
    I(:,:,2) = mat2gray(fu_fg_c(:,:,1));
    I(:,:,3) = zeros(size(mask));
    figure(20),imshow(I),title(sprintf('frame\\_%d, output',k));
    
    figure(21),imshow(colormap);title(sprintf('frame\\_%d, rgb',k))
